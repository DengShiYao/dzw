...
//    private static final String OUT_PATH = "./";
     ...
     * 代码生成者
     */
    private static final String AUTHOR = "dsy";
    ...
    private static final String URL = "jdbc:mysql://127.0.0.1:3306/dzw?useUnicode=true&characterEncoding=UTF-8&serverTimezone=GMT%2B8";
                ...
                .setStrategy(
                        ...
                        new StrategyConfig()
                                ...
                                .setNaming(NamingStrategy.underline_to_camel)// 表名生成策略
                                 .setInclude(new String[] {"engine_brand","car_brand","coin_spray","upkeep","minor","dzw_column_show","dzw_column_controller"}) // 需要生成的表
